...
fruits = ["Plum" , "Raspberry" , "Strawberry" , "Pomegranate"]
fruits2 = ["Alucha" , "Kiwi"]
...
names = ["jodi" , "aileen" , "lindsey" , "amma" , "samantha"]
...
names = ["ggfjkd" , "cxcxmnv" , "kldksj" , "saba" , "qwdfds" , "sddkfl"]
...
cities = ["oslo" , "berlin" , "irkutsk" , "tbilisi" , "lubeck"]
...
inpt = int(input("Enter an index number: "))
...
inpt = input("Enter a new element: ")
